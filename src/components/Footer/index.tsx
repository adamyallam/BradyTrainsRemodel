...
const Footer = () => {
  ...
  return (
    <footer className="overflow-hidden">
      <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0 border-t-2 border-dark mt-12">
        {/* <!-- footer menu start --> */}
        <div className="flex flex-wrap xl:flex-nowrap gap-10 xl:gap-19 justify-center sm:justify-between pt-12 xl:pt-18 pb-10 xl:pb-15">
          ...
          <div className="max-w-[330px] w-full text-center">
            <h2 className="mb-7.5 text-custom-1 font-medium text-dark">
              Contact & Support
            </h2>
            ...
            <ul className="flex flex-col items-center gap-3">
              <li className="flex gap-4.5">
                ...
                1046 S. Main St Greensburg, PA, 15601
              </li>
              ...
              <li>
                <a href="#" className="flex items-center gap-4.5">
                  ...
                  customerservice@bradystrains.com
                </a>
              </li>
            </ul>

            {/* <!-- Social Links start --> */}
            <div className="flex items-center justify-center gap-4 mt-7.5 pb-7.5">
              <a
                href="#"
                aria-label="Facebook Social Link"
                className="flex ease-out duration-200 hover:text-red-dark"
              >
                <svg
        ...
        <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex gap-5 flex-wrap items-center justify-between">
            <p className="text-dark font-medium">
              Copyright &copy; {year}. All rights reserved by Brady's Trains Outlet.
            </p>

            <div className="flex flex-wrap items-center gap-4">
              <p className="font-medium text-dark">We Accept:</p>

              <div className="flex flex-wrap items-center gap-6">
                <a href="#" aria-label="payment system with visa card">
                  <Image
                    src="/images/payment/payment-01.png"
                    alt="Google Pay"
                    width={40}
                    height={22}
                  />
                ...
                <a href="#" aria-label="payment system with paypal">
                  <Image
                    src="/images/payment/payment-02.png"
                    alt="Apple Pay"
                    width={44}
                    height={21}
                  />
                ...
                <a href="#" aria-label="payment system with master card">
                  <Image
                    src="/images/payment/payment-03.png"
                    alt="master card"
                    width={33}
                    height={24}
                  />
                ...
                <a href="#" aria-label="payment system with apple pay">
                  <Image
                    src="/images/payment/payment-04.png"
                    alt="PayPal"
                    width={52.94}
                    height={22}
                  />
                ...
                <a href="#" aria-label="payment system with google pay">
                  <Image
                    src="/images/payment/payment-05.png"
                    alt="Visa"
                    width={40}
                    height={22}
                  />
                ...
                <a href="#" aria-label="payment system with visa card">
                  <Image
                    src="/images/payment/payment-06.png"
                ...
                <a href="#" aria-label="payment system with visa card">
                  <Image
                    src="/images/payment/payment-07.png"
                    className="rounded-sm"
                    alt="Amex"
                    width={45}
                    height={22}
