        ...
        <div className="relative z-1 overflow-hidden rounded-xl bg-gray-4">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8 px-4 sm:px-7.5 xl:pl-12.5 xl:pr-14 py-11">
            <div className="max-w-[491px] w-full">
              <h2 className="max-w-[399px] text-red-dark font-bold text-center sm:text-left text-lg sm:text-xl xl:text-heading-4 mb-3">
                Don&apos;t Miss Out On Exclusive Offers!
              </h2>
              <p className="text-dark text-center sm:text-left">
                Register to receive news about the latest offers & discounts
              </p>
            </div>
