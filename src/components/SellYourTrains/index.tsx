...
const SellYourTrains = () => {
  return (
    <>
      <Breadcrumb title={"Sell Your Trains"} pages={["Sell Your Trains"]} />
              ...
              <div className="p-4 sm:p-7.5">
                <div className="flex flex-col gap-4">
                  <p className="flex items-center gap-4">
                    ...
                    Mail: customerservice@bradystrains.com
                  </p>
                  ...
                  <p className="flex gap-4">
                    ...
                    Address: 1046 S. Main St Greensburg, PA, 15601
                  </p>
                </div>
              </div>
              <InfoBox />
