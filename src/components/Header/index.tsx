                ...
                <div className="flex items-center">
                  ...
                  <div className="relative max-w-[325px] sm:min-w-[325px] w-full">
                    ...
                    <input
                      ...
                      autoComplete="off"
                      className="custom-search w-full rounded-r-[5px] bg-gray-1 !border-l-0 border border-gray-3 py-[5px] pl-4 pr-10 outline-none ease-in duration-200"
                    />
              ...
              <div className="flex items-center gap-5">
                ...
                >
                  <span className="inline-block relative">
                    ...
                    <span className="flex items-center justify-center font-medium text-2xs absolute -right-2 -top-2.5 bg-red-dark w-4.5 h-4.5 rounded-full text-white">
                      {product.length}
                    </span>
                  </span>
                  ...
                  {menuData.map((menuItem, i) =>
                    menuItem.submenu ? (
                      ...
                      >
                        <Link
                          href={menuItem.path}
                          className={`hover:text-red-dark text-sm font-medium text-dark flex ${stickyMenu ? "xl:py-2" : "xl:py-4"
                            }`}
                        >
                          {menuItem.title}
                        </Link>
            ...
            <div className="hidden xl:block">
              <ul className="flex items-center gap-5.5">
                <li className="py-4">
                  <Link
                    href="/wishlist"
                    className="flex items-center gap-1.5 font-medium text-custom-sm text-dark hover:text-red-dark"
                  >
                    <svg
                      className="fill-current"
                      width="16"
