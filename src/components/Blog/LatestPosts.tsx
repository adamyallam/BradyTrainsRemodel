        ...
        <div className="flex flex-col gap-6">
          ...
          {blogs.slice(0, 3).map((blog, key) => (
            <div className="flex items-center gap-4" key={key}>
              ...
              <div>
                <h3 className="text-dark leading-[22px] ease-out duration-200 mb-1.5 hover:text-red-dark">
                ...
                <span className="flex items-center gap-3">
                  <a
                    href="#"
                    className="text-custom-xs ease-out duration-200 hover:text-red-dark"
                  >
                    {blog.date}
                  </a>
